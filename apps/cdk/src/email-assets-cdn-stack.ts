...
export class EmailAssetsCdnStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: EmailAssetsCdnStackProps) {
    ...
    const webAcl = new wafv2.CfnWebACL(this, 'EmailAssetsWebAcl', {
      scope: 'CLOUDFRONT',
      defaultAction: { allow: {} },
      visibilityConfig: {
        cloudWatchMetricsEnabled: true,
        metricName: `pettzi-email-assets-${stage}`,
      ...
      rules: [
        {
          ...
          visibilityConfig: {
            cloudWatchMetricsEnabled: true,
            metricName: `pettzi-email-assets-rate-${stage}`,
            sampledRequestsEnabled: true,
          },
        },
        {
          ...
          visibilityConfig: {
            cloudWatchMetricsEnabled: true,
            metricName: `pettzi-email-assets-common-${stage}`,
            sampledRequestsEnabled: true,
          },
        },
        {
          ...
          visibilityConfig: {
            cloudWatchMetricsEnabled: true,
            metricName: `pettzi-email-assets-badinputs-${stage}`,
            sampledRequestsEnabled: true,
          },
        },
        {
          ...
          visibilityConfig: {
            cloudWatchMetricsEnabled: true,
            metricName: `pettzi-email-assets-sqli-${stage}`,
            sampledRequestsEnabled: true,
          },
        },
        {
          ...
          visibilityConfig: {
            cloudWatchMetricsEnabled: true,
            metricName: `pettzi-email-assets-iprep-${stage}`,
            sampledRequestsEnabled: true,
          },
        },
        {
          ...
          visibilityConfig: {
            cloudWatchMetricsEnabled: true,
            metricName: `pettzi-email-assets-anonip-${stage}`,
            sampledRequestsEnabled: true,
          },
        },
      ],
